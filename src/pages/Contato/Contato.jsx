...
//                 <form class="col-lg-8" id="central">
//                   <br>
//                   <br>
//                     <h1><center>
...
//                                     <input type="text" class="form-control valida-cpf-cnpj"  placeholder="000-000-000-00 / XX.XXX.XXX/XXXX-XX">
//                                 </div>
//                                 <div class="col-12">
...
//                                   <button type="submit" class="btn btn-primary btn-lg btn-block" id="teste-botao"onclick="validar()" >Enviar</button>
//                                   <br>
//                               </div>
